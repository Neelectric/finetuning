...
def pp_main(
    ...
    num_boxes: int = 7,
    model_name: str = "meta-llama/Llama-3.1-8B-Instruct", #meta-llama/Llama-3.1-8B #llama
    num_samples: int = 300,
    n_value_fetcher: int = 70,  # Goat / FLoat circuit: 50, Llama circuit: 20
    n_pos_trans: int = 30,  # Goat / FLoat circuit: 20, Llama circuit: 5
    n_pos_detect: int = 40,  # Goat / FLoat circuit: 30, Llama circuit: 10
    n_struct_read: int = 40,  # Goat / FLoat circuit: 5, Llama circuit: 5
