...
def minimality_main(
    ...
    circuit_root_path: str = "../experiment_1/results/path_patching/allenai/OLMo-2-1124-7B_circuit", #llama_circuit
    num_boxes: int = 7,
    ...
    results_path: str = "../experiment_1/results/minimality/allenai/OLMo-2-1124-7B_circuit", #llama_circuit
):
    """
